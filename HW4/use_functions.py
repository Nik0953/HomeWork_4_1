...
В файле дано описание программы.
Предлагается реализовать программу по описанию
...
Введите положительное целое число: 10 000 рублей
Введенное число: 10000   Верно?  да/нет да
Внесено 10000. Текущий остаток: 10000

Введите номер действия: 2

Текущий остаток:  10000
Покупка    Введите сумму покупки
Введите положительное целое число: 3
Введенное число: 3   Верно?  да/нет да
Введите название покупки: Хлеб
Покупка Хлеб на сумму 3. Текущий остаток: 9997

Введите номер действия: 2

Текущий остаток:  9997
Покупка    Введите сумму покупки
Введите положительное целое число: 17
Введенное число: 17   Верно?  да/нет да
Введите название покупки: Велосипед
Покупка Велосипед на сумму 17. Текущий остаток: 9980
